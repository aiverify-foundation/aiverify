  ...
  return (
    <>
      <div style={{ paddingBottom:'5px' }}>
        The principle of <b>{principleConfig.principle.principle}</b> was assessed through a process check comprising {stat.totalQuestions} testable criteria{principleConfig.principle.hasTechnicalTests?" and technical test":""}.
      </div>
