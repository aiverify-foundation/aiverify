...
def test_valid_run(get_data_instance_and_serializer_without_ground_truth):
    ...
    print(
        "data:",
        get_data_instance_and_serializer_without_ground_truth[0].get_data().shape,
    )
    print("model:", test_object._model_instance_and_serializer[0])
    print(
        "ground_truthz:",
        test_object._ground_truth_instance_and_serializer[0].get_data(),
    )
    print("ground_truthz:", test_object._ground_truth)
