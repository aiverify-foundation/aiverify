...
The Fairness Tree helps you to select the most relevant fairness metrics for your use case. Read more on how to understand the fairness tree [here](https://aiverify-foundation.github.io/aiverify/appendix/use-fairness-tree/). 
