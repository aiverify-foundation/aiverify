...
export const TechnicalInterpretationChart2 = ({ metric, container, data }) => {
  ...
  function getContent(display) {
    ...
    for (let oc in display) {
      ...
      content.push(
        <div key={i++} style={{border:"1px solid black", backgroundColor:"#eee", textAlign:"center", padding:'5px', marginBottom: '5px'}}>
  ...
  function getSimpleContent(display) {
    ...
    for (let oc in display) {
      ...
      content.push(
        <div key={Math.round(item.parity * 1000 + Number.EPSILON) / 1000} style={{border:"1px solid black", backgroundColor:"#eee", textAlign:"center", padding:'5px', marginBottom: '5px'}}>
