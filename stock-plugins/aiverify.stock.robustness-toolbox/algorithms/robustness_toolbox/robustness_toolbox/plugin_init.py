...
def run():
    parse_input_args()
    invoke_robustness_toolbox_plugin()
...
def parse_input_args():
    ...
    parser.add_argument(
        ...
        type=parse_plugin_argument_values,
        required=True,
        help="additional arguments fo type Dict for the plugin.",
    )
...
def invoke_robustness_toolbox_plugin():
    ...
    print(
        ...
        f"Plugin Argument Values: {args.plugin_argument_values}"
    )
    print("*" * 20)
