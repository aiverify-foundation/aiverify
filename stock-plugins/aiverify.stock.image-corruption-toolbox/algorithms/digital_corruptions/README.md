...
Use the [digital.ipynb](aiverify_digital_corruptions/utils/digital.ipynb) notebook to preview each corruption function and modify the default parameter values if needed.
