...
class Plugin(IAlgorithm):
    ...
    _name = "Digital Corruptions"
    _description = "Robustness plugin with digital corruptions"
    _version = "0.9.0"
    ...
    def __init__(
        ...
        **user_defined_params: Dict[str, Any],
        ...
        if not corruptions or "all" in corruptions:
            ...
            corruptions = [name for name in digital.CORRUPTION_FN if name.lower() in corruptions]  # fmt: skip
