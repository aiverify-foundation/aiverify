...
projectTemplateSchema.index({ 'projectInfo.name': 'text', 'projectInfo.description': 'text'});

export const ProjectTemplateModel = model('ProjectTemplateModel', projectTemplateSchema);
...
export const ProjectModel = ProjectTemplateModel.discriminator('ProjectModel', projectSchema);
