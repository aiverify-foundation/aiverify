...
class TestCollectionTask:
    ...
    def test_init(self, message_id, message_arguments, validation_schemas, task_type, task_update_cb):
        my_task = Task(message_id, message_arguments, validation_schemas, task_type, task_update_cb)
    ...
    def test_init_with_invalid_inputs(self, message_id, message_arguments, validation_schemas, task_type,
                                      task_update_cb, expected_output):
    ...
    def test_cancel(self, message_id, message_arguments, validation_schemas, task_type, task_update_cb):
        my_task = Task(message_id, message_arguments, validation_schemas, task_type, task_update_cb)
        my_task.process()
    ...
    def test_cancel_no_process(self, message_id, message_arguments, validation_schemas, task_type, task_update_cb):
        my_task = Task(message_id, message_arguments, validation_schemas, task_type, task_update_cb)
    ...
    def test_cleanup(self, message_id, message_arguments, validation_schemas, task_type, task_update_cb):
        my_task = Task(message_id, message_arguments, validation_schemas, task_type, task_update_cb)
        my_task.process()
    ...
    def test_cleanup_no_logger(self, message_id, message_arguments, validation_schemas, task_type, task_update_cb):
        my_task = Task(message_id, message_arguments, validation_schemas, task_type, task_update_cb)
    ...
    def test_get_formatted_results(self, message_id, message_arguments, validation_schemas, task_type, task_update_cb):
        my_task = Task(message_id, message_arguments, validation_schemas, task_type, task_update_cb)
        my_task.process()
    ...
    def test_get_formatted_results_no_process(self, message_id, message_arguments, validation_schemas, task_type,
                                              task_update_cb):
    ...
    def test_get_id(self, message_id, message_arguments, validation_schemas, task_type,
                    task_update_cb):
        my_task = Task(message_id, message_arguments, validation_schemas, task_type, task_update_cb)
        my_task.process()
        assert my_task.get_id() == "task:63b3f9764326cf3aa1ffd2ed-63b637da0ddd17d140912582"
    ...
    def test_get_id_no_process(self, message_id, message_arguments, validation_schemas, task_type,
                               task_update_cb):
        my_task = Task(message_id, message_arguments, validation_schemas, task_type, task_update_cb)
    ...
    def test_process(self, mocker, mock_success, mock_error_message,
                     message_id, message_arguments, validation_schemas, task_type, task_update_cb,
                     is_success, expected_error_message):
        with (
            mocker.patch.object(TaskArgument, "parse", return_value=(mock_success, mock_error_message)),
            mocker.patch.object(TaskProcessing, "process_pending_task",
                                return_value=(mock_success, mock_error_message)),
            mocker.patch.object(TaskProcessing, "process_new_task", return_value=(mock_success, mock_error_message))
        ):
            my_task = Task(message_id, message_arguments, validation_schemas, task_type, task_update_cb)
    ...
    def test_send_task_update(self, mocker, mock_success, mock_error_message, message_id, message_arguments,
                              validation_schemas, task_type, task_update_cb, has_output):
        with (
            mocker.patch.object(TaskArgument, "parse", return_value=(mock_success, mock_error_message)),
            mocker.patch.object(TaskProcessing, "process_pending_task",
                                return_value=(mock_success, mock_error_message)),
    ...
    def test_send_task_update_no_process(self, message_id, message_arguments,
                                         validation_schemas, task_type, task_update_cb, has_output):
