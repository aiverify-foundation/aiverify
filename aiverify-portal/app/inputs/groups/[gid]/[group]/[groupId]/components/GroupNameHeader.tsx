...
import { fetchConfigFiles } from '../../[groupId]/hooks/fetchConfigFiles'; // Import fetchConfigFiles
import { useDeleteGroup } from '../../[groupId]/hooks/useDeleteGroup';
import { useEditGroup } from '../../[groupId]/hooks/useEditGroupName';
import { exportToExcel } from '../../[groupId]/utils/exportToExcel'; // Import exportToExcel
...
const GroupHeader = ({ groupName: initialGroupName }: GroupHeaderProps) => {
  ...
  const handleSubmit = useCallback(
    ...
    [setName, initialGroupName, groupName /* checklists */]
  );
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      if (currentGroupData) {
        ...
        await exportToExcel(groupName, currentGroupData, configFiles);
      }
    } catch (error) {
