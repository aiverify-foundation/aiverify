      ...
      <div className='mt-6 w-full'>
        <div className='flex'>
          ...
          <div className='flex flex-col w-full mr-20'>
            <h3 className='text-2xl font-semibold mb-4'>Upload Plugin Zip File</h3>
            <h2 className='flex items-center gap-20'>
            ...
            <h2 className='text-lg font-semibold mb-2 mt-10'>Selected Files:</h2>
            ...
            <div className="flex items-center ml-auto mt-5">
              <Button
                className='px-5 py-2.5 bg-primary-400 mb-5 text-white border-none rounded-md disabled:bg-secondary-900 disabled:cursor-not-allowed disabled:text-secondary-600'
                size='sm'
