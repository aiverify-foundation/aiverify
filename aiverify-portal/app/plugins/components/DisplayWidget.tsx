...
import { TaskAltIcon, CheckCircleIcon, CrossCircleIcon } from '@/app/plugins/utils/icons';
...
const WidgetCard: React.FC<WidgetProps> = ({ widget }) => {
    ...
    <div className="bg-secondary-800 border border-secondary-300 p-6 rounded-lg mb-8" >
        <div className='flex items-center justify-between space-x-2'>
            ...
            {/* Dependencies Check */}
            <div className="flex items-center p-1 pl-2 pr-2 border-2 border-[#25A167] rounded-full space-x-1 min-w-[180px] break-words text-center">
