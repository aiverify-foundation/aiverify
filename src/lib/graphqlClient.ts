...
const URL = process.env.SERVER_URL || (process.env.NEXT_PUBLIC_SERVER_URL || 'http://localhost:3000');
const WSURL = process.env.WEBSOCKET_URL || (process.env.NEXT_PUBLIC_WEBSOCKET_URL || 'ws://localhost:4000/graphql');
//const URL = process.env.NEXT_PUBLIC_SERVER_URL || 'http://localhost:3000';
//const WSURL = process.env.NEXT_PUBLIC_WEBSOCKET_URL || 'ws://localhost:4000/graphql';
 ...
 */
export default function graphqlClient(ssrMode: boolean = false) {
