...
export type DatasetStatusUpdate = Pick<Dataset, 'filename' | 'status' | 'errorMessages'> & { status: AssetValidationStatus }
export type ModelStatusUpdate = Pick<Dataset, 'filename' | 'status' | 'errorMessages'> & { status: AssetValidationStatus }
