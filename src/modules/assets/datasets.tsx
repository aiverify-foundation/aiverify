                    ...
                    <Paper sx={{ p:2, m:2, display:'flex', flexDirection:'column', height: '80vh'}} >
                        <Box sx={{ mb: 2, height:'5%', display:'flex', alignItems:'center'}}>
                            <Button startIcon={<NavigateBeforeIcon />} color="secondary" sx={{mr:1}}
                                onClick={() => router.push('/assets')} data-testid="datasets-back-button"
                            />
                            <Typography variant="h6" sx={{ pl:2, flexGrow:1, fontWeight:'bold' }}>
                                Manage Assets &gt; Datasets
                            </Typography>
                        </Box>
                        <Container sx={{width: '100%', display:'flex', flexDirection:'row-reverse'}}>
                            <Button variant="contained" sx={{mb:1}}
                                onClick={() => router.push('/assets/newDataset')} data-testid="add-new-datasets-button"
                            >New Dataset &#43;</Button>
                        </Container>
