...
@pytest.mark.parametrize(
    ...
    [
        ...
        "https://github.com/aiverify-foundation/aiverify/raw/refs/heads/main/aiverify-test-engine/tests/io/user_defined_files/pytorch_pipeline_files.zip",  # noqa: E501
    ],
)
