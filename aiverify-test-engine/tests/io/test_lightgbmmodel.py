...
def plugin_test_data(request):
    ...
    file_path = str(test_dir / "user_defined_files/pickle_lightgbm_lgbmclassifier.sav")
    expected_model_algorithm = "lightgbm.sklearn.LGBMClassifier"
    expected_model_plugin_type = ModelPluginType.LIGHTGBM
    return (
        file_path,
        discover_path,
...
class PluginTest:
    def test_plugin(self, plugin_test_data):
        ...
        ), f"Failed to load model instance: {error_message}"
