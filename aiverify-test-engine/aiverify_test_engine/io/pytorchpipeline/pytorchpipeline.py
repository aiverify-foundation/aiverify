...
class Plugin(IPipeline):
    """
    The Plugin(pytorchpipeline) class specifies methods on
    ...
    _name: str = "pytorchpipeline"
    _description: str = "pytorchpipeline supports detecting pytorch pipeline"
    _version: str = "0.9.0"
    _metadata: PluginMetadata = PluginMetadata(_name, _description, _version)
    _plugin_type: PluginType = PluginType.PIPELINE
    _pipeline_plugin_type: PipelinePluginType = PipelinePluginType.PYTORCH
    ...
    def _identify_pipeline_algorithm(self, pipeline: Any) -> Tuple[bool, str]:
        ...
        Returns:
            ...
            pipeline name
        """
        is_success = isinstance(pipeline, torch.nn.Module)
