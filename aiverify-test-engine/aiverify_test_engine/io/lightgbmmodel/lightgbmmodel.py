...
class Plugin(IModel):
    """
    The Plugin(lightgbmmodel) class specifies methods on
    ...
    _supported_algorithms: List = ["lightgbm.sklearn.LGBMClassifier"]
    _name: str = "lightgbmmodel"
    _description: str = "lightgbmmodel supports detecting lightgbm models"
    _version: str = "0.9.0"
