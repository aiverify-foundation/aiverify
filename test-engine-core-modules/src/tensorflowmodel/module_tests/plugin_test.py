...
class PluginTest:
    ...
    def __init__(self, model_path: str, discover_path: Path):
        # Other variables
        ...
        self._expected_model_algorithm = "keras.engine.sequential.Sequential"
        self._expected_model_plugin_type = ModelPluginType.TENSORFLOW
