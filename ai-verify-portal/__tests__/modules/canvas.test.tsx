...
const GRID_PLACEHOLDER_CLASSNAME = '.react-grid-placeholder';
describe('Canvas Component', () => {
  ...
  describe('Project Flow', () => {
    ...
    describe.skip('Project Information Capture and Select Template screens', () => {
      ...
      it('should go to Select Report Template if Project Name is filled ', async () => {
        ...
        const companyInput: HTMLInputElement =
          await screen.findByPlaceholderText(/^Enter the company name$/i);
        ...
        await waitFor(() => {
          ...
          expect(
            screen.queryByText(/^Select Report Template$/i)
          ).not.toBeNull();
        });
    ...
    describe('Report Designer Screen', () => {
      it.skip('should render Report Designer screen', async () => {
        const user = userEvent.setup();
        const { container } = render(
      ...
      it.skip('should filter widgets by text search', async () => {
        const user = userEvent.setup();
        const { container } = render(
      ...
      it('should place widget on canvas', async () => {
        ...
        // expect(
        //   container.querySelector('.canvas_item_highlight')
        // ).not.toBeNull();
        // await user.click(
        //   await screen.findByPlaceholderText(/^Search Report Widgets$/i)
        // );
