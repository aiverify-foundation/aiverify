...
describe('Assets', () => {
  ...
  describe('Initial Render', () => {
    ...
    it('should render the back button', () => {
      render(<MockProviders><AssetsModule/></MockProviders>);
    ...
    it('should render the asset folder buttons', () => {
      render(<MockProviders><AssetsModule/></MockProviders>);
      expect(screen.getByTestId("add-new-dataset-button")).toHaveTextContent("New Dataset");
      expect(screen.getByTestId("add-new-model-button")).toHaveTextContent("New AI Model");
      expect(screen.getByTestId("open-dataset-list-button")).toHaveTextContent("Datasets");
      expect(screen.getByTestId("open-model-list-button")).toHaveTextContent("AI Models");
    })
