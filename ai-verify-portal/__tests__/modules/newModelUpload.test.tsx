...
describe('New Model Upload', () => {
  ...
  it('should render the back button', () => {
    render(<MockProviders apolloMocks={mocks}><NewModelUploadModule/></MockProviders>);
  ...
  it('should render the upload screen', () => {
    render(<MockProviders apolloMocks={mocks}><NewModelUploadModule/></MockProviders>);
    expect(screen.getByText('Add New AI Model > Upload Model File')).toBeDefined();
    ...
    expect(screen.getByTestId("upload-models-button")).toHaveAttribute('aria-disabled', 'true');
  })
