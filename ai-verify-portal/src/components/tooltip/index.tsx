...
function calculateTooltipPosition (
  ...
  switch (position) {
    case TooltipPosition.top:
      result.left = (triggerEl.offsetWidth > tooltipRect.width ? triggerRect.left + widthDiff : triggerRect.left - widthDiff) + offsetLeft;
    ...
    case TooltipPosition.left:
      result.top = (triggerEl.offsetHeight > tooltipRect.height ? triggerRect.top + heightDiff : triggerRect.top - heightDiff) + offsetTop;
...
function Tooltip(props : PropsWithChildren<TooltipProps>) {
  ...
  function handleMouseOver() {
    ...
    const placementStyle = calculateTooltipPosition(triggerRef.current,
      tooltipRef.current, position, offsetLeft, offsetTop);
  ...
  return <>
    <div ref={tooltipRef}
      ...
      <div className={clsx(styles.pointer, styles[positionClassname])}
        style={{ borderColor }} />
    ...
    <div ref={triggerRef}
      ...
      onMouseOut={handleMouseOut}>{children}</div>
  </>
}
