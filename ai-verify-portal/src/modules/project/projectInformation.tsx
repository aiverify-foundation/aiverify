...
import { ProjectTemplateStore, UpdateActionTypes } from '../projectTemplate/projectTemplateContext';
...
export default function ProjectInformationComponent(props: ProjectInfoProps) {
  ...
  const [ projectGeneralInfo, setProjectGeneralInfo] = useState<ProjectGeneralInfo>(() => projectStore.projectInfo || initialProjectInfo);
  ...
  useEffect(() => {
    if (onProjectInfoChange) onProjectInfoChange(validateProjectInfo(projectGeneralInfo));
    projectStore.dispatchProjectInfo({ type: UpdateActionTypes.UPDATE, payload: projectGeneralInfo });
  }, [projectGeneralInfo]);
    ...
    <div className={styles.container__limits}>
      <div className={styles.layout}>
        <div style={{ marginBottom: '25px'}}>
          ...
          <p className='headingDescription'>Create a new AI Testing Project to design the tests to be run on the AI Model <br/>and document the test results in the report generated</p>
        </div>
        <div className={styles.projectInfoForm}>
          <div className={styles.leftSection}>
            <h4>General Information</h4>
            <p>Provide general information required for the report generation</p>
          </div>
          ...
          <div className={styles.rightSection}>
            ...
            <TextInput
              ...
              value={useProjectNameAsTitle ? projectGeneralInfo.name : projectGeneralInfo.reportTitle}
              onChange={handleInputChange}
              maxLength={128}
              labelSibling={
                <div style={{ display: 'flex', alignItems: 'center'}}>
                  ...
                  <div style={{ fontWeight: 'normal', fontSize: '13px'}}>Use Project Name</div>
                </div>
              }/>
