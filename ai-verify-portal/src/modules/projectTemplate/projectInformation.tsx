...
export default function ProjectTemplateInformationComponent(props: TemplateInfoProps) {
    ...
    <div className={styles.container__limits}>
      <div className={styles.layout}>
        <div style={{ marginBottom: '25px'}}>
          <h3 className='screenHeading'>Create a new AI Testing Project Template</h3>
