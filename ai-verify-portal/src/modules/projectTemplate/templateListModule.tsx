...
import { useCloneProjectTemplate, useDeleteProjectTemplate } from 'src/lib/projectTemplateService';
							...
							<div className={styles.layout}>
								<div style={{ marginBottom: '25px'}}>
									<div style={{ display: 'flex' }}>
										<MenuBookIcon style={{ fontSize: '30px', marginRight: '15px' }} />
										<div>
										<h3 className='screenHeading'>Project Templates</h3>
										<p className='headingDescription'>Manage report templates</p>
										</div>
									</div>
								</div>

								{templates.length ? <div className={styles.searchRow}>
									...
									{projectTemplates.length ? <SortMenu selected={selectedSortOption} onClick={handleSortSelected}/> : null}
								</div> : <p>No Report Templates found. Click on &apos;Create New Template&apos; to design one.</p> }
