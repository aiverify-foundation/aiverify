...
function SortMenu(props: SortMenuProps) {
  ...
  <div id="pluginsSortMenu" className={sortMenuStyles.optionDisplay} onClick={handleSortMenuClick}>{sortDisplayText}
    <div className={sortMenuStyles.icon}>{showMenu ? <ArrowDropUpIcon /> : <ArrowDropDownIcon />}</div>
  </div>
    { showMenu ? 
      <ListMenu containerStyles={{
        position: 'absolute',
        zIndex: 101,
        fontSize: '13px',
        left: '0px',
        ...
        <ListMenuItem id="dateAsc" displayText='Installed Date (asc)' onClick={handleMenuItemClick(SortOption.InstallDateAsc)}/>
        <ListMenuItem id="dateDesc" displayText='Installed Date (desc)' onClick={handleMenuItemClick(SortOption.InstallDateDesc)}/>
        <ListMenuItem id="nameAsc" displayText='Plugin Name (asc)' onClick={handleMenuItemClick(SortOption.PluginNameAsc)}/>
        <ListMenuItem id="nameDesc" displayText='Plugin Name (desc)' onClick={handleMenuItemClick(SortOption.PluginNameDesc)}/>
      </ListMenu> : null
    }
  </div>
}
