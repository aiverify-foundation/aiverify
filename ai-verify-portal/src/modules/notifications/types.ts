...
type NewNotification = Omit<StandardNotification, 'id' | 'readStatus' | 'timestamp'>
type CreateNewNotificationInput = Optional<NewNotification, 'title'> & CreateReportStatusInput & AssetStatusInput
