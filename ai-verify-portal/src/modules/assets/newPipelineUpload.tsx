...
function PipelinesPicking({
  updateValidatingState,
  updateFileList,
}: PipelinesPickingProps) {
        ...
        <Box sx={{ flexGrow: 2 }}>
          ...
          <Box
            ...
            <Typography sx={{ pl: 2, fontSize: 14 }}>
              ...
              <b>Model Format:</b> Scikit-learn Pipeline
              <br />
              <b>Serialiser Type:</b> Pickle or Joblib
              <br />
            </Typography>
          </Box>
        </Box>
...
function PipelinesValidating({
  filesValidating,
  updateFile,
  onBackClick,
}: PipelinesValidatingProps) {
...
export default function NewPipelineUploadModule({
      ...
      <Paper
        ...
        {isValidating == false && (
          <PipelinesPicking
            ...
            updateFileList={updateFileList}></PipelinesPicking>
        )}
        {isValidating == true && (
          <PipelinesValidating
            filesValidating={filesValidating}
            updateFile={updateFile}
            onBackClick={handleBackIconClick}></PipelinesValidating>
        )}
      </Paper>
    );
  }
            ...
            <Paper
              ...
              <Box
                ...
                <Button
                  ...
                  data-testid="newpipelineupload-back-button"
                />
                <Typography
                  variant="h6"
                  sx={{ pl: 2, flexGrow: 1, fontWeight: 'bold' }}>
              ...
              {isValidating == true && (
                <PipelinesValidating
                  filesValidating={filesValidating}
                  updateFile={updateFile}></PipelinesValidating>
              )}
            </Paper>
          </Container>
        </Container>
